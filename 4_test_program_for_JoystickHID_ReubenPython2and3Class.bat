...
python "%CurrentDirectoryFullPath%test_program_for_JoystickHID_ReubenPython2and3Class.py" --IntegerIDdesired 4 --AllowNumberSymbolInJoystickNameDetectedToOverrideJoystickIntegerIDdetectedFlag 1
