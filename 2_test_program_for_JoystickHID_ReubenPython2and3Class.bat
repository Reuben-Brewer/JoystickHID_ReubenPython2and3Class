...
python "%CurrentDirectoryFullPath%test_program_for_JoystickHID_ReubenPython2and3Class.py" --IntegerIDdesired 2 --AllowNumberSymbolInJoystickNameDetectedToOverrideJoystickIntegerIDdetectedFlag 1
